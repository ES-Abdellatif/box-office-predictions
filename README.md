...
This `README` serves as an overall summary of the project and findings. For a full deep-dive into the analytics, you can explore the results in the pdf file `BoxOffice_Prediction_Markdown.pdf` along with the R code in the markdown file `BoxOffice_Prediction_Markdown.Rmd`. A Python version of the analysis is currently in progress.
